...
/**
 * The default implementation of {@link ISettingsFactory} using a predefined
 * constant object (that maybe <code>null</code>).
 * 
...
public class SettingsFactoryConstant implements ISettingsFactory
{
  ...
  public SettingsFactoryConstant (final Settings aSettings)
  {
