...
public final class TreeWalkerWithID
{
  ...
  private static <KEYTYPE, VALUETYPE, ITEMTYPE extends IBasicTreeItemWithID <KEYTYPE, VALUETYPE, ITEMTYPE>> void _walkTree (@Nonnull final ITEMTYPE aTreeItem,
  ...
  public static <KEYTYPE, VALUETYPE, ITEMTYPE extends IBasicTreeItemWithID <KEYTYPE, VALUETYPE, ITEMTYPE>> void walkTree (@Nonnull final IBasicTree <ITEMTYPE> aTree,
                                                                                                                          @Nonnull final IHierarchyWalkerCallback <? super ITEMTYPE> aCallback)
  {
