...
public final class ArrayIteratorShort
{
   ...
   *        Lenght. Must be &ge; 0.
   */
  private ArrayIteratorShort (final boolean bUnused,
                              @Nonnull final short [] aArray,
  ...
  public static ArrayIteratorShort createOfsLen (@Nonnull final short [] aArray,
                                                 ...
                                                 @Nonnegative final int nLength)
  {
    return new ArrayIteratorShort (true, aArray, nOfs, nLength);
  }
  ...
  {
    return new ArrayIteratorShort (aArray, nBegin, nEnd);
  }
}
