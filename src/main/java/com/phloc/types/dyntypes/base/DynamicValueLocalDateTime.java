...
/**
 * Dynamic value for objects of class {@link LocalDateTime}.
 * 
 * @author Philip Helger
 */
public final class DynamicValueLocalDateTime extends AbstractDynamicValue <LocalDateTime>
{
  public DynamicValueLocalDateTime ()
  {
    this (null);
  }

  public DynamicValueLocalDateTime (@Nullable final LocalDateTime aLocalDateTime)
  {
    super (SimpleDataTypeRegistry.DT_LOCALDATETIME, aLocalDateTime);
  }

  @Nullable
  public String getAsSerializationText ()
  {
    final LocalDateTime aValue = getValue ();
  ...
  public ESuccess setAsSerializationText (@Nullable final String sText)
  {
    ...
    else
    {
      ...
      setValue (PDTFactory.createLocalDateTimeFromMillis (aValue.longValue ()));
    }
  ...
  @Nonnull
  public DynamicValueLocalDateTime getClone ()
  {
    return new DynamicValueLocalDateTime (getValue ());
  }
}
