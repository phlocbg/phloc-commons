 ...
 * the {@link LongIterator LongIterator} interface.
 * <p />
...
public class IteratorLongIterator implements LongIterator
{
  ...
  /**
   * Create an {@link LongIterator LongIterator} wrapping the specified
   ...
   *         <code>null</code>.
   */
  public static LongIterator wrap (final Iterator iterator)
  {
   ...
   * @see #wrap
   */
  public IteratorLongIterator (final Iterator iterator)
  {
    _iterator = iterator;
  }
