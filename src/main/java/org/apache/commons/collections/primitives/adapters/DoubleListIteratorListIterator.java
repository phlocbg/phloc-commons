...
public class DoubleListIteratorListIterator implements ListIterator
{
   ...
   * {@link DoubleListIterator DoubleListIterator}. When the given
   ...
   *         <code>null</code>.
   */
  public static ListIterator wrap (final DoubleListIterator iterator)
  {
   ...
   * @see #wrap
   */
  public DoubleListIteratorListIterator (final DoubleListIterator iterator)
  {
    _iterator = iterator;
  }
