...
{
  private final BooleanListIterator m_aIterator;
   ...
   * @see #wrap
   */
  public BooleanListIteratorListIterator (@Nonnull final BooleanListIterator aIterator)
  {
  ...
  {
    return Boolean.valueOf (m_aIterator.previous ());
  }

  public void add (@Nonnull final Boolean obj)
  {
    m_aIterator.add (obj.booleanValue ());
  }

  public void set (@Nonnull final Boolean obj)
  {
    m_aIterator.set (obj.booleanValue ());
  }
