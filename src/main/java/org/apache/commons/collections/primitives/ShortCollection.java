...
public interface ShortCollection
{
   ...
   *         from being added to me
   */
  boolean addAll (@Nonnull ShortCollection aCont);
   ...
   */
  boolean contains (short aElement);
   ...
   */
  boolean containsAll (@Nonnull ShortCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeAll (@Nonnull ShortCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeElement (short aElement);
   ...
   *         when this operation is not supported
   */
  boolean retainAll (@Nonnull ShortCollection aCont);
   ...
   */
  @Nonnull
  short [] toArray (@Nonnull short [] aTarget);
}
