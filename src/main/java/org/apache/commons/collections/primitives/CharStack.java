 ...
 * ArrayCharList where the front of the list is the bottom of the stack and
...
public class CharStack
{
  ...
  private final ArrayCharList m_aList = new ArrayCharList ();
   ...
   *        the array to add
   */
  public CharStack (final char [] bits)
  {
