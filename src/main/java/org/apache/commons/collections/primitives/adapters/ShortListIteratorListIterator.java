...
public class ShortListIteratorListIterator implements ListIterator
{
   ...
   * {@link ShortListIterator ShortListIterator}. When the given <i>iterator</i>
   ...
   *         <code>null</code>.
   */
  public static ListIterator wrap (final ShortListIterator iterator)
  {
   ...
   * @see #wrap
   */
  public ShortListIteratorListIterator (final ShortListIterator iterator)
  {
    _iterator = iterator;
  }
