...
public interface ByteCollection
{
   ...
   *         from being added to me
   */
  boolean addAll (@Nonnull ByteCollection aCont);
   ...
   */
  boolean contains (byte aElement);
   ...
   */
  boolean containsAll (@Nonnull ByteCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeAll (@Nonnull ByteCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeElement (byte aElement);
   ...
   *         when this operation is not supported
   */
  boolean retainAll (@Nonnull ByteCollection aCont);
   ...
   */
  @Nonnull
  byte [] toArray (@Nonnull byte [] aTarget);
}
