 ...
 */
abstract class ProxyZZZListIterator extends ProxyZZZIterator implements ZZZListIterator
{
  ProxyZZZListIterator ()
  {}
  ...
  @Override
  @Nonnull
  protected final ZZZIterator getIterator ()
  {
    return getListIterator ();
  }
  
  @Nonnull
  protected abstract ZZZListIterator getListIterator ();
}
