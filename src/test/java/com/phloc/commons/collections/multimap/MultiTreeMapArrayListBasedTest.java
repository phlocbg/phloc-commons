 ...
 * @author philip
 */
public final class MultiTreeMapArrayListBasedTest
{
  @Test
  public void testAll ()
  {
    final MultiTreeMapArrayListBased <String, String> aMultiMap = new MultiTreeMapArrayListBased <String, String> ();
