...
/**
 * Test class for class {@link ASCII85Decoder}
 * 
 * @author philip
 */
public final class ASCII85DecoderTest
{
  @Test
  public void testDecode ()
  {
    ...
    final byte [] aDecoded = new ASCII85Decoder ().decode (sEncoded.getBytes (CCharset.CHARSET_US_ASCII_OBJ));
