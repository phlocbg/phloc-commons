...
public enum EXMLParserProperty implements IHasName
{
  ...
  * interface. The implementation used must have a zero argument
  * constructor.<br>
 ...
 SAX_XML_VERSION (EXMLParserPropertyType.SAX, "http://xml.org/sax/properties/document-xml-version", String.class);
  ...
  {
    this.m_ePropertyType = ePropertyType;
    this.m_sName = sName;
    // May be null
    this.m_aValueClass = GenericReflection.getClassFromNameSafe (sValueClassName);
    this.m_sValueClassName = sValueClassName;
  }
                              ...
                              @Nonnull final Class <?> aValueClass)
  {
    this.m_ePropertyType = ePropertyType;
    this.m_sName = sName;
    this.m_aValueClass = aValueClass;
    this.m_sValueClassName = aValueClass.getName ();
  }
  ...
  public void applyTo (@Nonnull final org.xml.sax.XMLReader aParser, final Object aValue)
  {
    ...
    try
    {
      aParser.setProperty (this.m_sName, aValue);
    }
  ...
  public void applyTo (@Nonnull final DocumentBuilderFactory aDocumentBuilderFactory, final Object aValue)
  {
    ...
    try
    {
      aDocumentBuilderFactory.setAttribute (this.m_sName, aValue);
    }
