...
public interface BooleanCollection
{
   ...
   *         from being added to me
   */
  boolean addAll (@Nonnull BooleanCollection aCont);
   ...
   */
  boolean contains (boolean aElement);
   ...
   */
  boolean containsAll (@Nonnull BooleanCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeAll (@Nonnull BooleanCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeElement (boolean aElement);
   ...
   *         when this operation is not supported
   */
  boolean retainAll (@Nonnull BooleanCollection aCont);
   ...
   */
  @Nonnull
  boolean [] toArray (@Nonnull boolean [] aTarget);
}
