...
abstract class BaseProxyDoubleList extends BaseProxyDoubleCollection implements DoubleList
{
  ...
  public void add (final int nIndex, final double aElement)
  {
  ...
  public double removeElementAt (final int nIndex)
  {
    return getProxiedList ().removeElementAt (nIndex);
  }

  public double set (final int nIndex, final double aElement)
  {
