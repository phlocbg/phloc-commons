...
public interface IntCollection
{
   ...
   *         from being added to me
   */
  boolean addAll (@Nonnull IntCollection aCont);
   ...
   */
  boolean containsAll (@Nonnull IntCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeAll (@Nonnull IntCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeElement (int aElement);
   ...
   *         when this operation is not supported
   */
  boolean retainAll (@Nonnull IntCollection aCont);
   ...
   */
  @Nonnull
  int [] toArray (@Nonnull int [] aTarget);
}
