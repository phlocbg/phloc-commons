...
public interface LongCollection
{
   ...
   *         from being added to me
   */
  boolean addAll (@Nonnull LongCollection aCont);
   ...
   */
  boolean contains (long aElement);
   ...
   */
  boolean containsAll (@Nonnull LongCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeAll (@Nonnull LongCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeElement (long aElement);
   ...
   *         when this operation is not supported
   */
  boolean retainAll (@Nonnull LongCollection aCont);
   ...
   */
  @Nonnull
  long [] toArray (@Nonnull long [] aTarget);
}
