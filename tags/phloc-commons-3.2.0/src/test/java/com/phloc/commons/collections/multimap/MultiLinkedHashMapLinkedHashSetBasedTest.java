 ...
 * @author philip
 */
public final class MultiLinkedHashMapLinkedHashSetBasedTest
{
  @Test
  public void testAll ()
  {
    final IMultiMapSetBased <String, String> aMultiMap = new MultiLinkedHashMapLinkedHashSetBased <String, String> ();
