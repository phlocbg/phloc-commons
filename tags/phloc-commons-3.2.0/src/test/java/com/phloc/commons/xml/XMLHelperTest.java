...
public final class XMLHelperTest extends AbstractPhlocTestCase
{
  ...
  {
    assertArrayEquals ("abc".toCharArray (), XMLHelper.getMaskedXMLText ("abc"));
    assertArrayEquals ("a&amp;c".toCharArray (), XMLHelper.getMaskedXMLText ("a&c"));
    assertArrayEquals ("a&amp;amp;c".toCharArray (), XMLHelper.getMaskedXMLText ("a&amp;c"));
    assertArrayEquals ("&amp;&lt;&gt;".toCharArray (), XMLHelper.getMaskedXMLText ("&<>"));
    assertArrayEquals ("&lt;&gt;&amp;".toCharArray (), XMLHelper.getMaskedXMLText ("<>&"));
    assertArrayEquals ("a&lt;c".toCharArray (), XMLHelper.getMaskedXMLText ("a<c"));
    assertArrayEquals ("a&gt;c".toCharArray (), XMLHelper.getMaskedXMLText ("a>c"));
    assertArrayEquals ("a&quot;c".toCharArray (), XMLHelper.getMaskedXMLText ("a\"c"));
    assertArrayEquals ("&lt;a&gt;".toCharArray (), XMLHelper.getMaskedXMLText ("<a>"));
    assertArrayEquals ("&#1;".toCharArray (), XMLHelper.getMaskedXMLText ("\u0001"));
    assertArrayEquals ("1 &amp; &#1;".toCharArray (), XMLHelper.getMaskedXMLText ("1 & \u0001"));
  }

  @Test
  public void testGetMaskedXMLTextLength ()
  {
    assertEquals (3, XMLHelper.getMaskedXMLTextLength ("abc"));
    assertEquals (1 + 5 + 1, XMLHelper.getMaskedXMLTextLength ("a&c"));
    assertEquals (1 + 4 + 1, XMLHelper.getMaskedXMLTextLength ("a<c"));
    assertEquals (1 + 4 + 1, XMLHelper.getMaskedXMLTextLength ("a>c"));
    assertEquals (1 + 6 + 1, XMLHelper.getMaskedXMLTextLength ("a\"c"));
    assertEquals (4 + 1 + 4, XMLHelper.getMaskedXMLTextLength ("<a>"));
    assertEquals (4, XMLHelper.getMaskedXMLTextLength ("\u0001"));
    assertEquals (2 + 5 + 1 + 4, XMLHelper.getMaskedXMLTextLength ("1 & \u0001"));
  }
