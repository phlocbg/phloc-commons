 ...
 * @author philip
 */
public final class MultiConcurrentHashMapTreeSetBasedTest
{
  @Test
  public void testAll ()
  {
    final IMultiMapSetBased <String, String> aMultiMap = new MultiConcurrentHashMapTreeSetBased <String, String> ();
