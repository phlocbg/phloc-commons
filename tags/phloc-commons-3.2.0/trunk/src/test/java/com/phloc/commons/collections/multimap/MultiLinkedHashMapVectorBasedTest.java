 ...
 * @author philip
 */
public final class MultiLinkedHashMapVectorBasedTest
{
  @Test
  public void testAll ()
  {
    final MultiLinkedHashMapVectorBased <String, String> aMultiMap = new MultiLinkedHashMapVectorBased <String, String> ();
