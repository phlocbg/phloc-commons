 ...
 * @author philip
 */
public final class MultiLinkedHashMapArrayListBasedTest
{
  @Test
  public void testAll ()
  {
    final MultiLinkedHashMapArrayListBased <String, String> aMultiMap = new MultiLinkedHashMapArrayListBased <String, String> ();
