...
public interface IStatisticsHandlerNumeric extends IStatisticsHandler
{
  ...
  /**
   * @return The smallest value. Returns {@link CGlobal#ILLEGAL_UINT} if the
   ...
   *         {@link CGlobal#ILLEGAL_UINT} if the invocation count is 0 to avoid
   *         a division by 0.
   */
  long getAverage ();

  /**
   * @return The biggest value. Returns {@link CGlobal#ILLEGAL_UINT} if the
   *         invocation count is 0.
   */
  long getMax ();
}
