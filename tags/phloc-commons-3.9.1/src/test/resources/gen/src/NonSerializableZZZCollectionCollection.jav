 ...
 */
final class NonSerializableZZZCollectionCollection extends AbstractZZZCollectionCollection
{
   ...
   */
  public NonSerializableZZZCollectionCollection (@Nonnull final ZZZCollection collection)
  {
