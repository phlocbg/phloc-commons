 ...
 * Collection} to the {@link ByteCollection ByteCollection} interface.
 * <p />
...
public final class CollectionByteCollection extends AbstractCollectionByteCollection implements Serializable
{
  ...
  @Override
  @Nonnull
  protected Collection <Byte> getCollection ()
  {
    return m_aCollection;
  }

  /**
   * Create an {@link ByteCollection ByteCollection} wrapping the specified
   ...
   */
  @Nullable
  public static ByteCollection wrap (@Nullable final Collection <Byte> aCollection)
  {
    if (null == aCollection)
      return null;
    if (aCollection instanceof Serializable)
      return new CollectionByteCollection (aCollection);
    return new NonSerializableCollectionByteCollection (aCollection);
  }
}
