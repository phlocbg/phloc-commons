...
public interface DoubleCollection
{
   ...
   *         from being added to me
   */
  boolean addAll (@Nonnull DoubleCollection aCont);
   ...
   */
  boolean contains (double aElement);
   ...
   */
  boolean containsAll (@Nonnull DoubleCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeAll (@Nonnull DoubleCollection aCont);
   ...
   *         when this operation is not supported
   */
  boolean removeElement (double aElement);
   ...
   *         when this operation is not supported
   */
  boolean retainAll (@Nonnull DoubleCollection aCont);
   ...
   */
  @Nonnull
  double [] toArray (@Nonnull double [] aTarget);
}
