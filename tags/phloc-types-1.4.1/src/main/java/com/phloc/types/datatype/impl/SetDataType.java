 ...
 */
@Immutable
public final class SetDataType extends AbstractComplexDataType implements ICollectionDataType
{
  private final IDataType m_aNestedDataType;

  public SetDataType (@Nonnull final IDataType aNestedDataType)
  {
    super (CDataType.ID_SET_PREFIX + CDataType.ID_TYPE_SEPARATOR + aNestedDataType.getID ());
  ...
  public boolean equals (final Object o)
  {
    ...
    if (!super.equals (o))
      return false;
    final SetDataType rhs = (SetDataType) o;
