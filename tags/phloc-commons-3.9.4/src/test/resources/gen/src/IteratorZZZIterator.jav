 ...
 * the {@link ZZZIterator ZZZIterator} interface.
 * <p />
...
public class IteratorZZZIterator implements ZZZIterator
{
  ...
  /**
   * Create an {@link ZZZIterator ZZZIterator} wrapping the specified
   * {@link Iterator Iterator}. When the given <i>iterator</i> is
   * <code>null</code>, returns <code>null</code>.
   *
   * @param iterator
   *        the (possibly <code>null</code>) {@link Iterator Iterator} to wrap
   * @return an {@link ZZZIterator ZZZIterator} wrapping the given
   *         <i>iterator</i>, or <code>null</code> when <i>iterator</i> is
   *         <code>null</code>.
   */
  @Nullable
  public static ZZZIterator wrap (@Nullable final Iterator <XXX> iterator)
  {
    return null == iterator ? null : new IteratorZZZIterator (iterator);
  }
}
