 ...
 * Concrete subclasses must provide the iterator to be tested. They must also
 * specify certain details of how the iterator operates by overriding the
 * supportsXxx() methods if necessary.
 * 
 ...
 */
public abstract class AbstractTestIterator <T> extends AbstractTestObject
{
   ...
   *        the test class name
   */
  public AbstractTestIterator (final String testName)
  {
    super (testName);
  }
   ...
   */
  public abstract Iterator <T> makeEmptyIterator ();
   ...
   */
  public abstract Iterator <T> makeFullIterator ();
  ...
  /**
   * Whether or not we are testing an iterator that can be empty. Default is
   * true.
   * 
  ...
  /**
   * Whether or not we are testing an iterator that supports remove(). Default
   * is true.
   * 
  ...
  public void testEmptyIterator ()
  {
    ...
    final Iterator <T> it = makeEmptyIterator ();
