...
public class SingleElementList <ELEMENTTYPE> implements List <ELEMENTTYPE>, IHasSize
{
  ...
  {
    return m_bHasElement ? CompareUtils.nullSafeEquals (m_aElement, aElement) : false;
  }
  ...
  {
    return m_bHasElement ? new SingleElementIterator <ELEMENTTYPE> (m_aElement) : EmptyIterator.<ELEMENTTYPE> getInstance ();
  }
  ...
  {
    return m_bHasElement ? new SingleElementListIterator <ELEMENTTYPE> (m_aElement) : EmptyListIterator.<ELEMENTTYPE> getInstance ();
  }
  ...
  public <ARRAYELEMENTTYPE> ARRAYELEMENTTYPE [] toArray (@Nonnull final ARRAYELEMENTTYPE [] aDest)
  {
    ...
    if (m_aElement != null && !aDest.getClass ().getComponentType ().isAssignableFrom (m_aElement.getClass ()))
      throw new ArrayStoreException ("The array class " +
                                     ...
                                     m_aElement.getClass ());
    final ARRAYELEMENTTYPE [] ret = aDest.length < 1 ? ArrayHelper.newArray (aDest, 1) : aDest;
  ...
  public boolean equals (final Object o)
  {
    ...
    return m_bHasElement == rhs.m_bHasElement && CompareUtils.nullSafeEquals (m_aElement, rhs.m_aElement);
  }
