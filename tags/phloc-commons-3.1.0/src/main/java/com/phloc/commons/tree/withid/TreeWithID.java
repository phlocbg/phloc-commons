 ...
 * @author philip
 */
public class TreeWithID <KEYTYPE, VALUETYPE> extends
                                             BasicTreeWithID <KEYTYPE, VALUETYPE, ITreeItemWithID <KEYTYPE, VALUETYPE>>
{
  public TreeWithID ()
  {
  ...
  public TreeWithID (@Nonnull final IBasicTreeItemWithIDFactory <KEYTYPE, VALUETYPE, ITreeItemWithID <KEYTYPE, VALUETYPE>> aFactory)
  {
    super (aFactory);
  }
}
