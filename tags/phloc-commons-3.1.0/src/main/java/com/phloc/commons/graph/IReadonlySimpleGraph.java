...
{
  @Nonnull
  GraphNode <VALUETYPE> getSingleStartNode ();

  @Nonnull
  @ReturnsMutableCopy
  Set <GraphNode <VALUETYPE>> getAllStartNodes ();

  @Nonnull
  @ReturnsMutableCopy
  Set <GraphNode <VALUETYPE>> getAllEndNodes ();

  @Nonnegative
  int getNodeCount ();

  @Nullable
  GraphNode <VALUETYPE> getNodeOfID (@Nullable String sID);
