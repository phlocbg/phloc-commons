 ...
 * Collection} to the {@link FloatCollection FloatCollection} interface.
 * <p />
...
public final class CollectionFloatCollection extends AbstractCollectionFloatCollection implements Serializable
{
  ...
  /**
   * Creates an {@link FloatCollection FloatCollection} wrapping the specified
   ...
   * @see #wrap
   */
  public CollectionFloatCollection (@Nonnull final Collection <Float> aCollection)
  {
  ...
  /**
   * Create an {@link FloatCollection FloatCollection} wrapping the specified
   ...
   */
  @Nullable
  public static FloatCollection wrap (@Nullable final Collection <Float> aCollection)
  {
    if (null == aCollection)
      return null;
    if (aCollection instanceof Serializable)
      return new CollectionFloatCollection (aCollection);
    return new NonSerializableCollectionFloatCollection (aCollection);
  }
}
