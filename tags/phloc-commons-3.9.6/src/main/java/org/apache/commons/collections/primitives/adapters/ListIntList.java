...
/**
 * Adapts a {@link Number}-valued {@link List List} to the {@link IntList
 * IntList} interface.
 * <p />
...
{
  private final List <Integer> m_aList;

  /**
   * Creates an {@link IntList IntList} wrapping the specified {@link List
   * List}.
   *
   * @param aList
   ...
   * @see #wrap
   */
  public ListIntList (@Nonnull final List <Integer> aList)
  {
    m_aList = aList;
  }
  ...
  /**
   * Create an {@link IntList IntList} wrapping the specified {@link List
   * List}. When the given <i>list</i> is <code>null</code>, returns
   * <code>null</code>.
   *
   * @param list
   *        the (possibly <code>null</code>) {@link List List} to wrap
   * @return a {@link IntList IntList} wrapping the given <i>list</i>, or
   *         <code>null</code> when <i>list</i> is <code>null</code>.
   */
  @Nullable
  public static IntList wrap (@Nullable final List <Integer> list)
  {
    if (null == list)
      return null;
