...
{
  private final ByteListIterator m_aIterator;
   ...
   * @see #wrap
   */
  public ByteListIteratorListIterator (@Nonnull final ByteListIterator aIterator)
  {
  ...
  {
    return Byte.valueOf (m_aIterator.previous ());
  }

  public void add (@Nonnull final Byte obj)
  {
    m_aIterator.add (obj.byteValue ());
  }

  public void set (@Nonnull final Byte obj)
  {
    m_aIterator.set (obj.byteValue ());
  }
