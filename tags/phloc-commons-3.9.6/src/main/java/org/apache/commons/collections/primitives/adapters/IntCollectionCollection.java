...
/**
 * Adapts an {@link IntCollection IntCollection} to the
...
{
  private transient IntCollection m_aCollection;
   ...
   * @see #wrap
   */
  public IntCollectionCollection (@Nonnull final IntCollection aCollection)
  {
  ...
  private void readObject (@Nonnull final ObjectInputStream in) throws IOException, ClassNotFoundException
  {
    ...
    m_aCollection = (IntCollection) in.readObject ();
  }
