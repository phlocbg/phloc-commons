...
/**
 * Dynamic value for objects of class {@link String}.
 * 
 * @author Philip Helger
 */
public final class DynamicValueString extends AbstractDynamicValue <String>
{
  public DynamicValueString ()
  {
    this (null);
  }

  public DynamicValueString (@Nullable final String sValue)
  {
    super (SimpleDataTypeRegistry.DT_STRING, sValue);
  }
  ...
  @Nonnull
  public DynamicValueString getClone ()
  {
    return new DynamicValueString (getValue ());
  }
}
