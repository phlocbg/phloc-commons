...
public final class XMLCharHelper
{
  ...
  private static final BitSet XML_INVALID_VALUE_CHAR_XML10 = new BitSet (0x10000);
  ...
  static
  {
    ...
    {
      XML_INVALID_NAME_START_CHAR_XML10.set (c, (c >= 0x0 && c <= 0x40) ||
                                                (c >= 0x5b && c <= 0x5e) ||
                                                (c == 0x60) ||
                                                (c >= 0x7b && c <= 0xbf) ||
                                                (c == 0xd7) ||
      ...
      XML_INVALID_NAME_CHAR_XML11.set (c, (c >= 0x0 && c <= 0x2c) ||
                                          ...
                                          (c >= 0xfdd0 && c <= 0xfdef) ||
                                          (c >= 0xfffe && c <= 0xffff));
      XML_INVALID_VALUE_CHAR_XML10.set (c, (c >= 0x0 && c <= 0x8) ||
                                           (c >= 0xb && c <= 0xc) ||
                                           (c >= 0xe && c <= 0x1f) ||
                                           (c >= 0xd800 && c <= 0xdfff) ||
                                           (c >= 0xfffe && c <= 0xffff));
  ...
  public static boolean isInvalidXMLTextChar (@Nonnull final EXMLVersion eXMLVersion, final int c)
  {
    ...
    {
      case XML_10:
        return XML_INVALID_VALUE_CHAR_XML10.get (c);
      case XML_11:
