...
public final class ArrayIteratorLong
{
   ...
   *        Lenght. Must be &ge; 0.
   */
  private ArrayIteratorLong (final boolean bUnused,
                             @Nonnull final long [] aArray,
  ...
  public static ArrayIteratorLong createOfsLen (@Nonnull final long [] aArray,
                                                ...
                                                @Nonnegative final int nLength)
  {
    return new ArrayIteratorLong (true, aArray, nOfs, nLength);
  }
  ...
  {
    return new ArrayIteratorLong (aArray, nBegin, nEnd);
  }
}
