...
public final class ArrayIterator <ELEMENTTYPE> implements Iterator <ELEMENTTYPE>
{
   ...
   *        Lenght. Must be &ge; 0.
   */
  private ArrayIterator (final boolean bUnused,
                         @Nonnull final ELEMENTTYPE [] aArray,
  ...
  public static <ELEMENTTYPE> ArrayIterator <ELEMENTTYPE> createOfsLen (@Nonnull final ELEMENTTYPE [] aArray,
                                                                        ...
                                                                        @Nonnegative final int nLength)
  {
    return new ArrayIterator <ELEMENTTYPE> (true, aArray, nOfs, nLength);
  }
  ...
  {
    return new ArrayIterator <ELEMENTTYPE> (aArray, nBegin, nEnd);
  }
}
