...
abstract class BaseUnmodifiableByteList extends BaseProxyByteList
{
  ...
  @Override
  public final byte removeElementAt (final int index)
  {
    throw new UnsupportedOperationException ("This ByteList is not modifiable.");
  }
  ...
  @Override
  public final boolean add (final byte element)
  {
    throw new UnsupportedOperationException ("This ByteList is not modifiable.");
  }
  ...
  @Override
  public final boolean removeElement (final byte element)
  {
    throw new UnsupportedOperationException ("This ByteList is not modifiable.");
  }
  ...
  @Override
  public final ByteList subList (final int fromIndex, final int toIndex)
  {
