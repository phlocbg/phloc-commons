...
public class ListIntList extends AbstractListIntList implements Serializable
{
  ...
  /**
   * Create an {@link IntList IntList} wrapping the specified {@link List List}.
   ...
   */
  public static IntList wrap (final List list)
  {
    if (null == list)
    {
      return null;
  ...
  /**
   * Creates an {@link IntList IntList} wrapping the specified {@link List List}
   * .
   * 
   * @see #wrap
   */
  public ListIntList (final List list)
  {
    _list = list;
  }
