...
public class ListIteratorDoubleListIterator implements DoubleListIterator
{
  ...
  /**
   * Create an {@link DoubleListIterator DoubleListIterator} wrapping the
   ...
   *         <code>null</code>.
   */
  public static DoubleListIterator wrap (final ListIterator iterator)
  {
    return null == iterator ? null : new ListIteratorDoubleListIterator (iterator);
  }

  /**
   * Creates an {@link DoubleListIterator DoubleListIterator} wrapping the
   * specified {@link ListIterator ListIterator}.
   * 
   * @see #wrap
   */
  public ListIteratorDoubleListIterator (final ListIterator iterator)
  {
    _iterator = iterator;
  }
