...
public class LongListIteratorListIterator implements ListIterator
{
   ...
   * {@link LongListIterator LongListIterator}. When the given <i>iterator</i>
   ...
   *         <code>null</code>.
   */
  public static ListIterator wrap (final LongListIterator iterator)
  {
   ...
   * @see #wrap
   */
  public LongListIteratorListIterator (final LongListIterator iterator)
  {
    _iterator = iterator;
  }
