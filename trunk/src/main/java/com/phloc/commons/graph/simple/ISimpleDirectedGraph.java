...
import com.phloc.commons.graph.IDirectedGraph;
...
public interface ISimpleDirectedGraph extends IDirectedGraph
{
   ...
   * {@link #createRelation(com.phloc.commons.graph.IDirectedGraphNode, com.phloc.commons.graph.IDirectedGraphNode)}
   * 
   * @param sFromNodeID
