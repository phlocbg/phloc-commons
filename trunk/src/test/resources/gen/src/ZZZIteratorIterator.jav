...
/**
 * Adapts an {@link ZZZIterator ZZZIterator} to the {@link java.util.Iterator
 * Iterator} interface.
 * <p />
 * This implementation delegates most methods to the provided
 * {@link ZZZIterator ZZZIterator} implementation in the "obvious" way.
 * 
 ...
 */
public class ZZZIteratorIterator implements Iterator <XXX>
{
  private final ZZZIterator m_aIterator;
   ...
   * {@link ZZZIterator ZZZIterator}. When the given <i>iterator</i> is
   * <code>null</code>, returns <code>null</code>.
   * 
   * @param iterator
   *        the (possibly <code>null</code>) {@link ZZZIterator ZZZIterator} to
   *        wrap
   * @return an {@link Iterator Iterator} wrapping the given <i>iterator</i>, or
   *         <code>null</code> when <i>iterator</i> is <code>null</code>.
   */
  @Nullable
  public static Iterator <XXX> wrap (@Nullable final ZZZIterator iterator)
  {
    return null == iterator ? null : new ZZZIteratorIterator (iterator);
  }
}
