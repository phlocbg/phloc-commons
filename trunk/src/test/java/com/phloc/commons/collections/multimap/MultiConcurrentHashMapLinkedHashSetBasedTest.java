 ...
 * @author philip
 */
public final class MultiConcurrentHashMapLinkedHashSetBasedTest
{
  @Test
  public void testAll ()
  {
    final IMultiMapSetBased <String, String> aMultiMap = new MultiConcurrentHashMapLinkedHashSetBased <String, String> ();
