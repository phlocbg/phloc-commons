 ...
 * @author philip
 */
public final class MultiConcurrentHashMapArrayListBasedTest
{
  @Test
  public void testAll ()
  {
    final MultiConcurrentHashMapArrayListBased <String, String> aMultiMap = new MultiConcurrentHashMapArrayListBased <String, String> ();
