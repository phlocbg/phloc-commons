 ...
 * @author philip
 */
public final class MultiConcurrentHashMapHashSetBasedTest
{
  @Test
  public void testAll ()
  {
    final IMultiMapSetBased <String, String> aMultiMap = new MultiConcurrentHashMapHashSetBased <String, String> ();
