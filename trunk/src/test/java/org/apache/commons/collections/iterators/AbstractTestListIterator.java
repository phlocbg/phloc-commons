 ...
 */
public abstract class AbstractTestListIterator <T> extends AbstractTestIterator <T>
{
   ...
   *        the test class name
   */
  public AbstractTestListIterator (final String testName)
  {
    super (testName);
  }
   ...
   */
  public abstract ListIterator <T> makeEmptyListIterator ();
   ...
   */
  public abstract ListIterator <T> makeFullListIterator ();
   ...
   */
  @Override
  public Iterator <T> makeEmptyIterator ()
  {
   ...
   */
  @Override
  public Iterator <T> makeFullIterator ()
  {
  ...
  public void testEmptyListIteratorIsIndeedEmpty ()
  {
    ...
    final ListIterator <T> it = makeEmptyListIterator ();
