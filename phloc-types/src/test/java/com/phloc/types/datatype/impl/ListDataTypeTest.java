...
/**
 * Test class for class {@link ListDataType}.
 * 
 * @author Philip Helger
 */
public final class ListDataTypeTest
{
  @Test
  public void testBasic ()
  {
    final ListDataType aLDT = new ListDataType (SimpleDataTypeRegistry.DT_INT);
    assertFalse (aLDT.isSimple ());
    assertTrue (aLDT.isComplex ());
    assertTrue (aLDT.isList ());
    assertFalse (aLDT.isSet ());
    assertEquals (SimpleDataTypeRegistry.DT_INT, aLDT.getNestedDataType ());
    ...
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (aLDT,
                                                                        new ListDataType (SimpleDataTypeRegistry.DT_LONG));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (aLDT,
