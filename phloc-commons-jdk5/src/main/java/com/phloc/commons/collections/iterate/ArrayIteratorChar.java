...
public final class ArrayIteratorChar
{
   ...
   *        Lenght. Must be &ge; 0.
   */
  private ArrayIteratorChar (final boolean bUnused,
                             @Nonnull final char [] aArray,
  ...
  public static ArrayIteratorChar createOfsLen (@Nonnull final char [] aArray,
                                                ...
                                                @Nonnegative final int nLength)
  {
    return new ArrayIteratorChar (true, aArray, nOfs, nLength);
  }
  ...
  {
    return new ArrayIteratorChar (aArray, nBegin, nEnd);
  }
}
